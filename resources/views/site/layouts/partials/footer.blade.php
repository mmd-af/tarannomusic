        ...
        <div class="text-center">
            ...
            <h6>
                ...
                <strong class="social-links">
                    <a class="" style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p>
                                شرکت ایده پردازان آریو وب فعال در زمینه برنامه نویسی، طراحی سایت، طراحی اپلیکیشن های
                                موبایل
                            </p>
